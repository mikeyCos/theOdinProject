...
const hourlyBuilder = {
      ...
      if (!(_hourly_config__WEBPACK_IMPORTED_MODULE_1__["default"][key] instanceof Array)) {
        ...
        weatherData.forecast.forecastday[0][key].forEach((item) => {
          ...
          if (date1.getTime() < date2.getTime()) {
            _hourly_config__WEBPACK_IMPORTED_MODULE_1__["default"][key].push(item);
          }
        });
      }
    });
  ...
  render() {
    ...
    hourlyContentHeading.textContent = (0,_helpers_formatDate__WEBPACK_IMPORTED_MODULE_2__["default"])(_hourly_config__WEBPACK_IMPORTED_MODULE_1__["default"].current.last_updated);
    ...
    _hourly_config__WEBPACK_IMPORTED_MODULE_1__["default"].hour.forEach((hour) => {
      hourlyContentList.appendChild(
        (0,_helpers_createContentRows__WEBPACK_IMPORTED_MODULE_3__["default"])(
...
const todayBuilder = {
  ...
  render(weatherData) {
    ...
    const todayDetailsList = (0,_utilities_createElement__WEBPACK_IMPORTED_MODULE_0__["default"])('ul');
    todayDetails.id = 'today_details';
    _today_config__WEBPACK_IMPORTED_MODULE_1__["default"].forEach((obj) => {
      const todayDetailsListItem = (0,_utilities_createElement__WEBPACK_IMPORTED_MODULE_0__["default"])('li');
      // please refactor me!
      let text;
