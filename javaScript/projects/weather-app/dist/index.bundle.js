...
const homeBuilder = {
  ...
  render() {
    const home = (0,_utilities_createElement__WEBPACK_IMPORTED_MODULE_0__["default"])('div');
    home.id = 'home';
...
const mainBuilder = {
  ...
  bindEvents() {
    ...
    _containers_pubSub__WEBPACK_IMPORTED_MODULE_0__["default"].subscribe('setWeather', this.setWeather);
  },
  render(key) {
...
async function getWeather(value) {
  ...
  try {
    ...
    _pubSub__WEBPACK_IMPORTED_MODULE_0__["default"].publish('setWeather', !response.ok ? weatherData.error : weatherData);
    if (!response.ok) {
